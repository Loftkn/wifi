...
################################################################################
## Form generated from reading UI file 'interfaceGjDwwb.ui'
##
...
"font-size: 30px")
        ...
        self.bar_charts_cont.setSizeConstraint(QLayout.SetNoConstraint)
        ...
        self.temperature_bar_chart_cont.addWidget(self.pushButton, 0, 0, 1, 1, Qt.AlignHCenter)
