...
class MainWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.ui.pushButton_2.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.temperature_bar_chart))
    ...
    def create_nested_donuts(self):
        ...
        self.setup_donuts()
        #donut.doubleClicked.connect(self.handle_double_clicked) 
